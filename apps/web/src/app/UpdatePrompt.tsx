...
export function UpdatePrompt() {
  ...
  return (
    <div className="fixed inset-x-3 bottom-24 z-50 mx-auto flex max-w-md items-center gap-3 rounded-2xl bg-ink-900 p-3 pl-4 text-white shadow-raised sm:bottom-6">
      <RefreshCw className="h-5 w-5 text-accent-500" aria-hidden />
