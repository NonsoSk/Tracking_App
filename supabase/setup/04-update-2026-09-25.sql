-- UPDATE (25 Sep 2026): several people in charge, and responsibility by community type.
-- Only needed if you ALREADY ran all-in-one.sql before this date (run 03-update-2026-09-24.sql first if you
-- have not run it yet). Safe to run more than once.
