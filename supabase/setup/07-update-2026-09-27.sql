-- UPDATE (27 Sep 2026): add staff and reset PINs from the app (no server functions); app renamed to Indorama Grievance Portal.
-- Run after 06-update-2026-09-26.sql. Safe to run more than once.
