-- UPDATE (24 Sep 2026): officer in charge per community, set from the app.
-- Only needed if you ALREADY ran all-in-one.sql before this date. Safe to run more than once.
